<template>
  <section ref="graphs" class="relative">
...
export default {
  ...
  beforeUnmount() {
    window.removeEventListener('resize', this.calculateNumOfGraphs);
  },
  watch: {
    lastPrice() {
      this.graphs.push(this.lastPrice);
      this.calculateNumOfGraphs();
    },
  },
};
</script>
